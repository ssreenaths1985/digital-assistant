...
def job():
    ...
    if(len(response.text) > 0):
        ...
        r.set("top10coursesByrating", "No data found")
    ...
    if(len(response1.text) > 0):
        ...
        r.set("top10coursesBycompletion", "No data found")
    ...
    if(len(response2.text) > 0):
        ...
        r.set("top10mdosByusersOnboard", "No data found")
    ...
    if(len(response3.text) > 0):
        ...
        r.set("top10mdosBycompletion", "No data found")
    ...
    if(len(response4.text) > 0):
        ...
        r.set("top10mdosByliveCourses", "No data found")
    ...
    if(len(response5.text) > 0):
        ...
        r.set("cbpProviderleaderBoard", "No data found")
    ...
    if(len(response6.text) > 0):
        ...
        r.set("userEngagementbyHubs", "No data found")
