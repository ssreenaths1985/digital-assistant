...
def get_recent_content(text, entities, session_id):
    ...
    if(len(response.text) > 0):
        ...
        elements = [{"type":"direct", "intent" : "recent_content", "text" : "No data found", "statusCode": 200}]
    return elements
...
def get_trending_discussions_posts(text, entities, uid, session_id):
    ...
    if(len(response.text) > 0):
        ...
        elements = [{"type":"direct","entities":entities, "intent" : "trending_discussions", "text" : "No data found", "statusCode": 200}]
    return elements
...
def get_courses_completed(text, entities, session_id):
    ...
    if(len(response.text) > 0):
        ...
        elements = [{"type":"direct","entities":entities, "intent" : "courses_started", "text" : "No data found", "statusCode": 200}]
    return elements
...
def get_courses_live_or_draft_or_review(text, entities, session_id):
    ...
    if(len(response.text) > 0):
        ...
        elements = [{"type":"direct","entities":entities, "intent" : "courses_live_or_draft_or_review", "text" : "No data found", "statusCode": 200}]
    return elements
...
def get_users_onboarded(text, entities, session_id):
    ...
    if(len(response.text) > 0):
        ...
        elements = [{"type":"direct","entities":entities, "intent" : "users_onboarded", "text" : "No data found", "statusCode": 200}]
    return elements
...
def get_number_of_courses_added(text, entities, session_id):
    ...
    if(len(response.text) > 0):
        ...
        elements = [{"type":"direct","entities":entities, "intent" : "number_of_courses_added", "text" : "No data found", "statusCode": 200}]
    return elements
...
def get_top_10_courses_by_ratings(text, entities, session_id):
    ...
    if(len(plots) > 0):
        ...
        elements = [{"type":"direct","entities":entities, "intent" : "top_10_courses_by_completions", "text" : details, "statusCode": 200}]
    return elements
...
def get_cbp_provider_leaderboard(text, entities, session_id):
    ...
    if(len(plots) > 0):
        ...
        elements = [{"type":"direct", "intent" : "cbp_provider_leaderboard", "text" : details, "statusCode": 200}]
    return elements
...
def get_top_10_mdos_by_course_completions(text, entities, session_id):
    ...
    if(len(plots) > 0):
        ...
        elements = [{"type":"direct","entities":entities, "intent" : "top_10_mdos_by_users_onboarded", "text" : details, "statusCode": 200}]
    return elements
...
def get_user_engagement_by_factor(text, entities, session_id):
    ...
    if(len(plots) > 0):
        ...
        elements = [{"type":"direct","entities":entities, "intent" : "user_engagement_by_factor", "text" : details, "statusCode": 200}]
    return elements
