    ...
    return (
      <nav className="navbar col-md-12 col-lg-12 col-xl-12 tabText horizontalNavBarHeight dateFilter">
        <div className="row d-sm-flex d-md-flex d-lg-flex mb-4">
          <div className="btn-group customDropdown dropdown-menu-right" id="dashboardDropdown">
            ...
            <div 
              type=""
              className="dropdown-toggle ml-2 mr-2 right"
              id="dropdownMenuReference"
              data-toggle="dropdown"
              aria-haspopup="true"
              aria-expanded="false"
              data-reference="parent"
              style={{ marginTop: "0.3em", cursor:"pointer"}}
            >
              <span>
                <img
            ...
            <div
              className="dropdown-menu  pull-left mr-5 cursorStyleOne smallDDMenu" style={{marginLeft: '15em', marginTop: '1em'}}
