...
async getData()
  {
    await DatasetService.getDataset(this.props.match.params.bot).then((response) => {
      ...
      this.setState({
        testingDatasets:Object.keys(response.payload.response)
      });
      } else {
            ...
            <div className="row admin-pannel">
               ...
               <div className="row col-md-12 mt-3 ">
                    {this.state.publishedVersions.map((models, key) => (
                      ...
                      <div className={`row col-md-12 mt-2 ${this.state.loadedModel === models
                        ...
                        }>{models} <span class="badge badge-pill badge-secondary ml-3">{this.state.publishedEnvs[key]}</span></label>
                      </div>
              ...
              <div className="col-md-9 admin-right-section">
                ...
                <div className="row col-md-12">
                  ...
                  <div>
                  <button className="btn primary mt-3" onClick={this.onSubmit}>
                        Run Training
                      </button>
                  </div>
                  ...
                  <div className="row col-md-12 mt-2">
                    ...
                    <div className="panel-body dropdown mt-4 mb-3 d-none d-md-flex d-lg-flex langDropdown" style={{width:"320px"}}>
                      <span
                        ...
                        aria-haspopup="true"
                        aria-expanded="false"
                        onClick={ () =>{ this.setState({disableTest : false})}}>
                        {this.state.test} <i className="fa fa-caret-down pull-right" style={{fontSize:'15px'}} aria-hidden="true"/>
                      </span>

                      <div className="dropdown-menu mr-9 cursorStyleOne smallDDMenu pull-right"aria-labelledby="dropdownRoleLink">
                      {this.state.testingDatasets.map((datasets, key)=>( 
                        <p className="dropdown-item dateFilterTextColor" style={{width:"300px"}} onClick={ () =>{
                          this.setState({test:datasets})
                        }}>
                          {datasets}
                        </p>
                      ))}
                  ...
                  <div>
                  <button className="btn primary mt-3" onClick={this.onSubmit} disabled={this.state.disableTest}>
                        Run Testing
